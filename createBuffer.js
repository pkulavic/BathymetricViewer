export function createBufferGeometry(header, data) {
    // Creates a 3D terrain geometry with color-coded elevation data for land and underwater features using Three.js BufferGeometry.
    ...
    const elevationScale = 8; // Adjust the scaling factor as needed
    ...
    for (let i = 0; i < positions.length; i += 3) {
        ...
        // Get the color from cm_data
        const [r, g, b] = cm_data[safeIndex];
